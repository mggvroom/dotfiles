...
# I added my color on .vimrc but everytime I opened a file using vim the background was still black so I asked Copilot what I'm missing on the code and it told me to add colorscheme iceberg at the bottom of the code.


# I tested my script and it worked.
